...
void solve() {
    ...
    FOR(i,1,m){
        ...
        FOR2(j,1,2*n,2){
            int a=p[j],b=p[j+1];
            if(s[a][i]=='G'&&s[b][i]=='C')cnt[a]++;
            if(s[a][i]=='C'&&s[b][i]=='P')cnt[a]++;
            if(s[a][i]=='P'&&s[b][i]=='G')cnt[a]++;
            if(s[b][i]=='G'&&s[a][i]=='C')cnt[b]++;
            if(s[b][i]=='C'&&s[a][i]=='P')cnt[b]++;
            if(s[b][i]=='P'&&s[a][i]=='G')cnt[b]++;
        }
